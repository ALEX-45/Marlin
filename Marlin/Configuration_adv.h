...
//
#define NUM_Z_STEPPER_DRIVERS 2//my   // (1-4) Z options change based on how many

#if NUM_Z_STEPPER_DRIVERS > 1
  #define Z_MULTI_ENDSTOPS//my
  #if ENABLED(Z_MULTI_ENDSTOPS)
    #define Z2_USE_ENDSTOP          _ZMIN_ //my _XMAX_
